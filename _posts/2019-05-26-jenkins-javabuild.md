...
![Jenkins Mainpage](/assets/images/jenkins_screenshot/jenkins_mainpage.png)
...
![Jenkins Create Job](/assets/images/jenkins_screenshot/jenkins_createjob.png)

Jobの名前とテンプレートを選んだなら、`Ok`を押してJobを生成します。

![Jenkins Job Main](/assets/images/jenkins_screenshot/jenkins_jobmain.png)
...
![Jenkin Git Config](/assets/images/jenkins_screenshot/jenkins_gitconfigure.png)
...
![Jenkins Git Credential](/assets/images/jenkins_screenshot/jenkins_gitcredential.png)
...
![Jenkins Job Saved](/assets/images/jenkins_screenshot/jenkins_jobsaved.png)
...
![Jenkins Git Job](/assets/images/jenkins_screenshot/jenkins_gitjob1.png)

実際のビルドでどんな処理が行われたかを確認するには、左のメニューから`Console Output`をクリックします。Linuxのコンソールのような画面で表示されます。

![Jenkins Git Job 2](/assets/images/jenkins_screenshot/jenkins_gitjob2.png)
...
![Jenkins Git Job 3](/assets/images/jenkins_screenshot/jenkins_gitjob3.png)
...
![Jenkins Gradle Config](/assets/images/jenkins_screenshot/jenkins_gradleconfigure1.png)
...
![Jenkins Gradle Config 2](/assets/images/jenkins_screenshot/jenkins_gradleconfigure2.png)
...
![Jenkins Gradle Build](/assets/images/jenkins_screenshot/jenkins_gradlebuild.png)

無事Gradleでのビルドが終わりました。それではJarファイルがちゃんとできたか確認しましょう。

![Jenkins Gradle Build JAR](/assets/images/jenkins_screenshot/jenkins_gradlebuildjar.png)
