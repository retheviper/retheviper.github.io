...
이전에는 [AWS 자격](../aws-certification-associate-developer)에 대한 글도 썼지만, 클라우드라는 플랫폼이 제공하는 서비스의 본질은 제공자가 달라도 크게 다르지 않습니다. IaaS나 PaaS의 개념, 그리고 백엔드 서비스를 클라우드에 배포하고 구성한 경험이 있다면 준비가 아주 어렵지는 않을 거라고 느꼈습니다.
