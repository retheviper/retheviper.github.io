...
Quarkus는 [RHEL](https://www.redhat.com/ja/technologies/linux-platforms/enterprise-linux)로 잘 알려진 Red Hat이 만든 Java용 웹 프레임워크입니다. 공식 홈페이지 설명이 가장 정확하니, 우선 이 문장을 그대로 보는 편이 좋습니다.
